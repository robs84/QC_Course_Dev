...
Now define the phase shift. A phase shift takes every computational basis state (except |0⟩) and flips the sign on the state.

To accomplish this make a 2-qubit circuit, and to both qubits apply a Hadamard, Z, CZ, and another Hadamard (acting on a ket it would look like HCZZH). Can you deduce how the application of this phase shift amplifies the signal of the target state?
